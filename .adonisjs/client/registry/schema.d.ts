...
export interface Registry {
  ...
  'gateways.priority': {
    ...
    types: {
      ...
      response: ExtractResponse<Awaited<ReturnType<import('#controllers/gateways_controller').default['priority']>>>
      errorResponse: ExtractErrorResponse<Awaited<ReturnType<import('#controllers/gateways_controller').default['priority']>>> | { status: 422; response: { errors: SimpleError[] } }
    }
  }
  'transactions.index': {
    methods: ["GET","HEAD"]
